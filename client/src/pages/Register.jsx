...
import { registerUser as register } from '../redux/slices/authSlice';
      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-12">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-3xl font-display font-bold text-gray-900 mb-2">Create an account</h1>
      ...
      <div className="hidden lg:block flex-1 bg-gray-50 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-16">
          <div className="text-white max-w-lg">
            <h2 className="text-4xl font-display font-bold mb-4">Join the conversation.</h2>
            <p className="text-lg text-gray-200">Connect with millions of readers and writers on BlogSpace.</p>
          </div>
        </div>
      </div>
    </div>
